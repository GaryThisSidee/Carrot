...
class User(UserMixin):
    ...
    def create(self, asset_name, unit_name, total, decimals, default_frozen,
               url):
        """Creates an asset, with the user as the creator"""
        return create_asset(self.public_key, asset_name, unit_name, total,
                            decimals, default_frozen, url, self.id)

    def createee(self, metadataJSON,unit_name,asset_name,url):
        return create_nft(self.public_key, self.id, metadataJSON,unit_name,asset_name,url)
